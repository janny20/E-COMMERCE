...
define('DB_HOST', 'localhost:3306'); // Default MySQL port
...
// Define the application root path for reliability
if (!defined('APP_ROOT')) {
...
// File upload paths
define('PRODUCT_UPLOAD_PATH', APP_ROOT . '/uploads/products/');
define('VENDOR_UPLOAD_PATH', APP_ROOT . '/uploads/vendors/');
define('USER_UPLOAD_PATH', APP_ROOT . '/uploads/users/');
