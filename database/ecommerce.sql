...
CREATE TABLE vendor_earnings (
    ...
    vendor_id INT NOT NULL,
    order_id INT NOT NULL,
    net_earning DECIMAL(10, 2) NOT NULL DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (vendor_id) REFERENCES vendors (id) ON DELETE CASCADE,
    FOREIGN KEY (order_id) REFERENCES orders (id) ON DELETE CASCADE
);
...
VALUES (
    ...
    (
        'Beauty & Health',
        'beauty-health',
        'Beauty products and health supplements'
    );
...
VALUES (
        ...
        '$2y$10$O0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',
        'customer'
    );
...
VALUES (
        'vendor_supplier',
        'vendor@supplier.com',
        '$2y$10$jS8.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',
        'vendor'
    );
